...
public:
    ...
    virtual void setDetails(const string &details)
    {
        ...
        title = details.substr(0, pos1);
        author = details.substr(pos1 + 1, pos2 - pos1 - 1);
        year = stoi(details.substr(pos2 + 1));
    }
};
...
public:
    ...
    string getType() const override { return "FictionBook"; }
...
public:
    ...
    string getType() const override { return "NonFictionBook"; }
...
public:
    ...
    string getType() const override { return "ReferenceBook"; }
